    ...
    <div>
      ...
      <div className='flex justify-center items-center border-blue-500'>
        <form onSubmit={saveData} className='w-full border-2 border-sky-500 p-4 m-4 rounded-md md:w-1/2 lg:w-1/3'>
          ...
          <div>
            <label htmlFor="phoneNo" className="text-xl font-lobster flex flex-col">
              Phone Number
            </label>
            <input
              type="text"
              ...
              className="w-full p-2 m-2 border-black rounded-md"
              required
              maxLength="10"
              pattern="\d{10}"
          ...
          <div>
            <label htmlFor="altPhoneNo" className="text-xl font-lobster flex flex-col">
            ...
            <input
              ...
              onChange={(event) => {
                if (/^\d{0,10}$/.test(event.target.value)) {
                  setAltPhoneNo(event.target.value);
                }
              }}
              className="w-full p-2 m-2 border-black rounded-md"
              required
