...
app.post('/api/register', async (req, res) => {
    try {
        const { collegeName, category, phoneNo, altPhoneNo, transactionId } = req.body;
        const newRegisterUser = new Register({ collegeName, category, phoneNo, altPhoneNo, transactionId });
